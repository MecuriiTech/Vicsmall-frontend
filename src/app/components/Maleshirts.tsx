  ...
  const cards = Array.from({ length: 10 }).map((_, index) => (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundImage: "url('/image04.png')" }}
      ></div>
  ...
  return (
    <div className="relative mt-12 mb-12">
      ...
      <div className="flex justify-between items-center text-black px-4 mb-4">
        <span className="text-xl font-semibold">Male shirts</span>
        <button className="text-sm flex">
          <span className=" mr-3">View More</span><span className=" mr-3"><Image src={Line} alt="line"/></span>
        </button>
      </div>
